  ...
  try {
    ...
    if (event.httpMethod === 'POST') {
      ...
      const row = {
        ...
        confidence: Number.isFinite(body?.confidence) ? Number(body.confidence) : null,
        duration_seconds: Number.isFinite(body?.duration_seconds) ? Number(body.duration_seconds) : null,
      }
