...
function html(status, htmlBody) {
  return { statusCode: status, headers: { 'Content-Type': 'text/html; charset=utf-8' }, body: String(htmlBody || '') }
}
...
<body class="p-3 p-md-4">
  <div class="container">
    ...
    <div class="report-card">
      ...
      <div class="mt-4 small text-muted">Thank you for instructing me in this matter. If you have any questions or require anything further, please contact chambers.</div>
    </div>
  </div>
</body>
</html>`
